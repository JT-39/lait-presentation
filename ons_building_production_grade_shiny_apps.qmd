...
::: fragment
-   [LAIT's Background]{style="font-size: 1.75em;"}
<br>
<br>
<br>
...
:::
::: fragment
-   [Planning a Shiny App]{style="font-size: 1.75em;"}
<br>
<br>
<br>
...
:::
::: fragment
-   [Development & Coding]{style="font-size: 1.75em;"}
<br>
<br>
<br>
...
```r
date_Input(inputId = "date1",
label = "What is your date of birth?",
hint_label = "For example, 31 3 1980")
```
![](images/shinyGovstyle-date.png)
:::
:::
::: {.column}
::: fragment
...
# Display the interactive plot
int_plot <- ggiraph::girafe(ggobj = plot)
int_plot
```
